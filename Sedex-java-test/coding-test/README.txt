...
request originated, and the third column is the time in milliseconds which the request took to complete.
...
The features which you must implement have been prototyped in the class com.sedex.test.DataFilterer. You must implement the 
